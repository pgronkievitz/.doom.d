...
#+name: fonts
#+begin_src elisp :noweb yes
(setq doom-font (font-spec :family "DaddyTimeMono Nerd Font Mono" :size 15)
      doom-unicode-font (font-spec :family "DaddyTimeMono Nerd Font Mono" :size 15)
      doom-big-font (font-spec :family "DaddyTimeMono Nerd Font Mono" :size 30)
